...
// This is usually done when new implementations or code refactoring (done for reasons like performance gains) result in a 
// different public API, while the other parts of the system are still using the old API and need to be adapted to work together.

// In this example, we have an old API, i.e. OldCalculator class, and a new API, i.e. NewCalculator class. 
// The OldCalculator class provides an operationmethod for both addition and subtraction, while the NewCalculator provides 
// separate methods for addition and subtraction. The Adapter class CalcAdapterwraps the NewCalculator to add the operation method to
